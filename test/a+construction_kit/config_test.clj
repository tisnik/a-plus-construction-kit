...
(deftest test-update-configuration-existence
  ...
  (testing "if the a+construction-kit.config/update-configuration definition exists."
...
(deftest test-load-configuration-from-ini-existence
  ...
  (testing "if the a+construction-kit.config/load-configuration-from-ini definition exists."
