...
(deftest test-header-existence
  ...
  (testing "if the a+construction-kit.html-renderer-widgets/header definition exists."
...
(deftest test-navigation-bar-existence
  ...
  (testing "if the a+construction-kit.html-renderer-widgets/navigation-bar definition exists."
...
(deftest test-footer-existence
  ...
  (testing "if the a+construction-kit.html-renderer-widgets/footer definition exists."
...
(deftest test-back-button-existence
  ...
  (testing "if the a+construction-kit.html-renderer-widgets/back-button definition exists."
...
(deftest test-submit-button-existence
  ...
  (testing "if the a+construction-kit.html-renderer-widgets/submit-button definition exists."
...
(deftest test-add-button-existence
  ...
  (testing "if the a+construction-kit.html-renderer-widgets/add-button definition exists."
...
(deftest test-remove-button-existence
  ...
  (testing "if the a+construction-kit.html-renderer-widgets/remove-button definition exists."
...
(deftest test-disabled-submit-button-existence
  ...
  (testing "if the a+construction-kit.html-renderer-widgets/disabled-submit-button definition exists."
    (is (callable? 'a+construction-kit.html-renderer-widgets/disabled-submit-button))))
...
(deftest test-radio-button-existence
  ...
  (testing "if the a+construction-kit.html-renderer-widgets/radio-button definition exists."
...
(deftest test-help-button-existence
  ...
  (testing "if the a+construction-kit.html-renderer-widgets/help-button definition exists."
...
(deftest test-canvas-existence
  ...
  (testing "if the a+construction-kit.html-renderer-widgets/canvas definition exists."
...
(deftest test-drop-down-existence
  ...
  (testing "if the a+construction-kit.html-renderer-widgets/drop-down definition exists."
