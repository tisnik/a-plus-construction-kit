...
(deftest test-finish-processing-existence
  ...
  (testing
    "if the a+construction-kit.server/finish-processing definition exists."
...
(deftest test-process-select-app-page-existence
  ...
  (testing
    "if the a+construction-kit.server/process-select-app-page definition exists."
...
(deftest test-app-type-name->label-existence
  ...
  (testing
    "if the a+construction-kit.server/app-type-name->label definition exists."
...
(deftest test-process-select-language-page-existence
  ...
  (testing
    "if the a+construction-kit.server/process-select-language-page definition exists."
...
(deftest test-process-configure-modules-page-existence
  ...
  (testing
    "if the a+construction-kit.server/process-configure-modules-page definition exists."
...
(deftest test-gui-call-handler-existence
  ...
  (testing
    "if the a+construction-kit.server/gui-call-handler definition exists."
